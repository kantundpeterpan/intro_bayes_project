...
alpha_dens <- ggplot(alpha_plot_df, aes(x = value)) +
  geom_density() +
  labs(x = "Parameter Value", y = "Density") + #,
       #title = "Posterior Density by Parameter") +
  facet_wrap(~ parameter, labeller = labeller(parameter = as_labeller(label_math, label_parsed)), scales = "free") + # Use facet_wrap on the 'parameter' column
  theme_minimal() +
  theme(strip.text = element_text(size = 11))
ggsave("fig_alpha_dens.png", alpha_dens, height = 4, width = 6)
```
...
ggsave("fig_compplot_q7.png", q7_compplot, height = 4, width = 6)
```
