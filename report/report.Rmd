...
par(mfcol=c(1,3))
gelman.plot(mcmc[,pi_params[1]])
gelman.plot(mcmc[,pi_params[2]])
gelman.plot(mcmc[,pi_params[3]])
```
...
par(mfcol=c(1,3))
geweke.plot(mcmc[,pi_params[1]])
geweke.plot(mcmc[,pi_params[2]])
geweke.plot(mcmc[,pi_params[3]])
```
